...
import static com.internet_of_everything.chineesecards.MainActivity.context;
...
public class EndDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public EndDrawerToggle(Activity activity, DrawerLayout drawerLayout, Toolbar toolbar,
        ...
        toggleButton.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_folder_black_36dp));
